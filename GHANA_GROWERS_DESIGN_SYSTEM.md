# Ghana Growers Design System v1.0

This freezes the first public design language for Ghana Growers.

## Brand Position

Ghana Growers should feel like a premium agricultural platform for Ghana: calm, natural, trustworthy, modern, human, and confident.

It should not feel corporate, loud, cheap, busy, or generic.

## Color Tokens

| Token | Hex | Usage |
| --- | --- | --- |
| Forest Trust | `#143A1F` | Primary brand color, logo, primary buttons, strong CTA areas |
...
Primary interface font: `Inter`, with system sans-serif fallback.

Editorial heading font: `Cormorant Garamond`, with Georgia fallback.

Use Cormorant Garamond only for:

- Homepage hero
- Major landing page heroes
- About page editorial headings
- GG Standard page editorial headings
- Marketing/editorial headings

Do not use serif type in:
...
If a component requires explanation, redesign it.

Core defaults:

- Primary button height: `48px`
- Border radius: `12px`
- Section spacing: `120px` desktop, reduced on tablet/mobile
- Card shadow: `0 14px 40px rgba(20, 58, 31, 0.08)`
- Hover card shadow: `0 18px 50px rgba(20, 58, 31, 0.12)`
...
- Image zoom: `1.03x`
- Button hover: soft color shift only
- No dramatic animations

## Icon Language

Use subtle category backgrounds instead of one universal green square.

- Marketplace: Forest Trust
- Farmer Hub: muted sage
- Logistics: Harvest Gold
- Quality Standard: sage/ivory

Icons should help scanning. They should not become decoration for its own sake.

## Section Rhythm

Recommended public homepage rhythm:

- Hero: Morning Ivory
- Marketplace: White
- Farmer Hub: Morning Mist
- Quality Standard: White
- Featured Farmers: Morning Ivory
- Join Network: Forest Trust

No gradients. No repeating technical backgrounds.

## Copywriting

Write short, practical, human copy:
