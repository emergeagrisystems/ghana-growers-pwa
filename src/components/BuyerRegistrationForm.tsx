...
export const BuyerRegistrationForm = withPublicSubmissionGate(BuyerRegistrationFormAvailable, "buyer-registration", "Buyer registration", false);

function BuyerRegistrationFormAvailable() {
