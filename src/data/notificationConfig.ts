export const farmerRegistrationNotifications = {
  ...
  subjectPrefix: "New farmer registration",
  googleSheetName: "Farmer Registrations"
};

export const buyerRegistrationNotifications = {
  // Admin-editable notification recipients. Add or remove addresses here.
  adminEmails: ["hello@ghanagrowers.com"],
  fromEmail: "Ghana Growers <onboarding@ghanagrowers.com>",
